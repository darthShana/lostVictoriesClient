...
public class CustomTerrainGridTest extends SimpleApplication {
    ...
    public static void main(final String[] args) {
        CustomTerrainGridTest app = new CustomTerrainGridTest();
        app.start();
    }
...
//        String modelName = "Scenes/worldGrid" + "/" + "world_grid" + "-" + 0 + "-" + 0 + ".j3o";
//        Node model = (Node) assetManager.loadModel(modelName);
//        this.terrain = (TerrainQuad)model.getChild("terrain-world_grid-" + 0 + "-" + 0);
//        this.terrain = new CustomTerrainQuad(assetManager);

//        final Node loadModel = (Node) assetManager.loadModel("Scenes/testScene4.j3o");
//        this.terrain = (TerrainQuad) loadModel.getChild("terrain-testScene4");
    ...
    private final ActionListener actionListener = new ActionListener() {
        ...
        public void onAction(final String name, final boolean keyPressed, final float tpf) {
            if (name.equals("Lefts")) {
                if (keyPressed) {
                    CustomTerrainGridTest.this.left = true;
                } else {
                    CustomTerrainGridTest.this.left = false;
                }
            } else if (name.equals("Rights")) {
                if (keyPressed) {
                    CustomTerrainGridTest.this.right = true;
                } else {
                    CustomTerrainGridTest.this.right = false;
                }
            } else if (name.equals("Ups")) {
                if (keyPressed) {
                    CustomTerrainGridTest.this.up = true;
                } else {
                    CustomTerrainGridTest.this.up = false;
                }
            } else if (name.equals("Downs")) {
                if (keyPressed) {
                    CustomTerrainGridTest.this.down = true;
                } else {
                    CustomTerrainGridTest.this.down = false;
                }
            } else if (name.equals("Jumps")) {
                CustomTerrainGridTest.this.player3.jump();
