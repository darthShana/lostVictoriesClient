...
public class TerrainGridAssetTest extends SimpleApplication {
    ...
    public static void main(final String[] args) {
        TerrainGridAssetTest app = new TerrainGridAssetTest();
        app.start();
    }
...
//        AssetTileLoader grid = new AssetTileLoader(assetManager, "testgrid", "TerrainGrid");
        ...
        CustomTileLoader grid = new CustomTileLoader(assetManager, "world_grid", "Scenes/worldGrid");
        this.terrain = new TerrainGrid("terrain", 65, 1025, grid);
    ...
    private final ActionListener actionListener = new ActionListener() {
        ...
        public void onAction(final String name, final boolean keyPressed, final float tpf) {
            if (name.equals("Lefts")) {
                if (keyPressed) {
                    TerrainGridAssetTest.this.left = true;
                } else {
                    TerrainGridAssetTest.this.left = false;
                }
            } else if (name.equals("Rights")) {
                if (keyPressed) {
                    TerrainGridAssetTest.this.right = true;
                } else {
                    TerrainGridAssetTest.this.right = false;
                }
            } else if (name.equals("Ups")) {
                if (keyPressed) {
                    TerrainGridAssetTest.this.up = true;
                } else {
                    TerrainGridAssetTest.this.up = false;
                }
            } else if (name.equals("Downs")) {
                if (keyPressed) {
                    TerrainGridAssetTest.this.down = true;
                } else {
                    TerrainGridAssetTest.this.down = false;
                }
            } else if (name.equals("Jumps")) {
                TerrainGridAssetTest.this.player3.jump();
