...
public abstract class Weapon {
    ...
    public abstract boolean isAboutToFire(String animName);
    ...
    public void transitionFiringSequence(GameAnimChannel channel, ParticleEmitter muzzelFlash) {
        ...
        int i = getFiringSequence().indexOf(channel.getAnimationName());
    ...
    public abstract String getDieAtion(GameAnimChannel channel);
    ...
    public abstract boolean isProjectileWeapon();
