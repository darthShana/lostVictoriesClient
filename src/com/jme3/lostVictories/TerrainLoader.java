...
class TerrainLoader {
    ...
    public Node loadTerrain(AssetManager assetManager, BulletAppState bulletAppState, Camera camera, Set<GameObjectNode> objects, String scene) {
...
//        terrain.setMaterial(mat_terrain);
        ...
        for(Node n: movableObjects){            
            GameObjectNode g = new GameObjectNode(n, bulletAppState, 0, false);
